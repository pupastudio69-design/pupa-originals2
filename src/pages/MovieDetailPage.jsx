...
const COMMENTS = [
  { id: 1, user: 'Chioma A.', avatar: 'C', comment: 'Absolutely breathtaking cinematography. African cinema at its finest!', likes: 42, time: '2h ago' },
  { id: 2, user: 'Kofi M.', avatar: 'K', comment: 'The storyline had me gripped from start to finish. 10/10 Pupa Original!', likes: 31, time: '4h ago' },
  { id: 3, user: 'Amina D.', avatar: 'A', comment: 'Finally a streaming platform that represents us properly. This is cinema!', likes: 58, time: '1d ago' },
  { id: 4, user: 'Emeka O.', avatar: 'E', comment: "The score alone deserves an award. Who's the composer?", likes: 19, time: '1d ago' },
];
  ...
  return (
    <div className="min-h-screen bg-pupa-bg page-enter pb-20">
      ...
      <div className="px-5 -mt-16 relative z-10">
        ...
        {/* Gift button */}
        <button className="w-full mb-6 py-3 rounded-xl border border-yellow-500/30 text-yellow-400 text-sm font-medium flex items-center justify-center gap-2 hover:bg-yellow-500/10 transition-colors">
          <Gift size={16} /> Gift this movie to a friend
        </button>
        ...
        {/* Reactions */}
        <div className="mb-6">
          <h3 className="font-body font-semibold text-white mb-3">React</h3>
          <div className="flex gap-3">
            {REACTIONS.map((r, i) => (
              <button
                key={i}
                onClick={() => setActiveReaction(i)}
                className="flex flex-col items-center gap-1 transition-all duration-200"
                style={{ transform: activeReaction === i ? 'scale(1.3)' : 'scale(1)' }}
              >
