    ...
    <div className={`flex items-center gap-3 ${animate ? 'animate-float' : ''}`}>
      <div style={{ width: size, height: size }} className="relative flex-shrink-0">
        <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%' }}>
          ...
          <polygon points="28,18 28,70 76,44" fill="none" stroke="url(#borderGrad)" strokeWidth="4" strokeLinejoin="round" filter="url(#glow)" />
          <polygon points="32,23 32,65 70,44" fill="url(#playGrad)" />
      ...
      {showText && (
        <div className="flex flex-col leading-none">
          <span
            className="font-display font-bold tracking-[0.15em] uppercase"
            style={{
              fontSize: size * 0.45,
          ...
          <span
            className="font-body font-semibold tracking-[0.25em] uppercase"
            style={{ 
              fontSize: size * 0.22,
